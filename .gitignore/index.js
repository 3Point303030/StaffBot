...
client.login('NTkyMjk3MDQyMjk1MTI4MDY0.XQ-q7A.VhlI0Jpr9g-zc9h4CIAekuI2GLQ')
...
client.on('guildMemberAdd', function (member) {
    ...
    member.guild.channels.get('535533972441137152').send(embed)
    member.addRole('535533972441137152')
})
